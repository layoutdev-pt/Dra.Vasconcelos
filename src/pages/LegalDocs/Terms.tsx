      ...
      <div className="max-w-[1000px] mx-auto px-6 lg:px-8">
        ...
        >
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-primary">Termos e Condições</h1>
              <p className="text-gray-400 text-sm mt-1">Regras e diretrizes para a utilização do nosso website e serviços.</p>
            </div>
          </div>
          ...
          <div className="prose prose-lg max-w-none text-gray-600 leading-relaxed space-y-8">
            ...
            <section>
              <h2 className="text-xl font-bold text-primary mb-4">4. Limitações</h2>
              <p>
