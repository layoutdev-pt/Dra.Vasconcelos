...
export const DisputeResolution: React.FC = () => {
  return (
    <div className="min-h-screen bg-surface pt-32 pb-20 transition-colors duration-500">
        ...
        >
          ...
          <div className="prose prose-lg max-w-none text-site-text-muted leading-relaxed font-light space-y-12 [&_strong]:text-site-text [&_strong]:font-bold [&_b]:text-site-text [&_b]:font-bold">
            <section className="space-y-6">
              ...
              <div className="bg-surface-muted/50 p-8 rounded-4xl border border-surface-border space-y-6">
                <p className="m-0">
              ...
              <div className="bg-secondary/5 p-6 rounded-2xl border border-secondary/10 flex gap-4">
                <div className="shrink-0 w-10 h-10 bg-secondary/10 rounded-full flex items-center justify-center">
            ...
            <section className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={idx} className="p-6 border border-surface-border rounded-2xl hover:border-secondary/30 transition-colors group">
