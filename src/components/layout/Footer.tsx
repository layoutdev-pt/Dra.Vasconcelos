...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-primary pt-16 pb-8 text-white border-t border-white/5 mt-auto font-display transition-colors duration-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="flex items-center">
              <Link to="/">
                <OptimizedImage src={whiteLogo} alt="Dra. Alexandra Vasconcelos" objectFit="object-contain" className="h-20 md:h-28 w-auto transition-all duration-500" />
              </Link>
            </div>
          ...
          <div className="lg:col-span-2">
            ...
            {footerStatus === 'success' ? (
              <p className="text-xs text-green-500 font-semibold">✓ Subscrito com sucesso!</p>
            ) : (
              <form className="flex flex-col gap-2" onSubmit={handleFooterSubmit}>
                <input 
                  ...
                  className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded-lg focus:outline-none focus:border-secondary text-xs text-white disabled:opacity-50 transition-colors" 
                  required
                />
                <button 
                  type="submit" 
