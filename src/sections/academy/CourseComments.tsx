  ...
  return (
    <div className="max-w-[900px] mx-auto mt-20 pt-16 border-t border-surface-border">
      <h3 className="text-2xl font-bold text-site-text mb-8 flex items-center gap-3">
        ...
        Dúvidas e Comentários <span className="text-site-text-muted font-medium text-lg">({comments.length})</span>
      </h3>
      ...
      <div className="mb-12 bg-surface-muted/30 rounded-3xl p-6 border border-surface-border">
        {!user ? (
          <div className="text-center py-6">
            <p className="text-site-text-muted mb-4 font-medium">Tens alguma dúvida sobre este curso?</p>
            <Link to="/entrar" className="inline-flex px-6 py-2.5 bg-secondary text-white font-bold rounded-xl hover:bg-secondary/90 transition-colors shadow-lg shadow-secondary/20">
          ...
          {topLevelComments.map(comment => (
            <div key={comment.id} className="flex flex-col gap-3">
              ...
              <div className="bg-surface border border-surface-border p-5 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-site-text-muted text-sm leading-relaxed whitespace-pre-wrap">{comment.content}</p>
              ...
              {getReplies(comment.id).map(reply => (
                <div key={reply.id} className="ml-10 bg-surface-muted/50 border border-surface-border p-4 rounded-xl">
