          ...
          <div className="w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              {[
                ...
                { icon: BriefcaseMedical, iconBg: 'bg-blue-500/10', iconColor: 'text-blue-400', title: 'Medicina Biológica Integrativa', desc: 'Avaliação avançada da saúde com foco na prevenção, equilíbrio e otimização do organismo.' },
                  ...
                  >
                    <div className="text-center mb-10">
                      ...
                      <h3 className="text-2xl md:text-3xl font-bold text-site-text mb-3">
                        Medicina Biológica Personalizada
                      </h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {[
                        ...
                        { label: 'Testes Genéticos', desc: 'Análise de variações genéticas para a Medicina Natural (doenças cardiovasculares, metabólicas, diabetes, neurodegenerativas e cancro).' },
                      ].map((item, i) => (
