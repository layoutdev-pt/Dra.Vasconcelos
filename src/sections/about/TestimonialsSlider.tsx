      ...
      <div className="max-w-[1400px] 2xl:max-w-[1600px] mx-auto px-6 lg:px-8 2xl:px-12 relative z-10">
        ...
        <div className="relative max-w-4xl mx-auto">
            ...
            >
              {[0, 1, 2, 3].map((f) => {
                ...
                return (
                  <div 
                    key={f}
                    className="absolute top-0 left-0 w-full h-full bg-[#111827] border border-white/10 rounded-3xl shadow-2xl p-8 md:p-14 flex items-center justify-center flex-col"
                    style={{ 
                  ...
                  >
                    ...
                    <div className="relative z-10 w-full flex flex-col justify-between h-full">
                      <p className="text-lg md:text-3xl font-light italic leading-relaxed text-gray-200 mt-4 text-center grow flex items-center justify-center">
                        "{testimonial.text}"
                      </p>
          ...
          <div className="flex justify-center items-center gap-4 mt-10">
            <button 
              onClick={handlePrev}
              className="p-3 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 text-gray-300 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-secondary"
              ...
              {testimonials.map((_, idx) => (
                <button
                  ...
                  className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${
                    idx === currentIndex ? 'bg-secondary w-6' : 'bg-white/20 hover:bg-white/40'
                  }`}
